...
export class MenuPage {
  ...
  load(){
      this.http.get('http://localhost/service-ionic/retrieve-data-makanan.php').map(res => res.json()).subscribe(data => {this.itemk = data;});
      this.http.get('http://localhost/service-ionic/retrieve-data-minuman.php').map(res => res.json()).subscribe(data => {this.itemn = data;});
  }
